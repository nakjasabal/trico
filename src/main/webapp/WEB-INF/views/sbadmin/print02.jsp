...
function printOpen(idx) {
	...
	$.ajax({
		...
		success : function(resData){
			console.log(resData);
			open('onlyPrint02.do?idx='+idx,'print','left=0,top=0,width=800,height=900');
		},		 
...
-->    
    ...
    <c:forEach items="${rows}" var="row">
    	...
    	<tr>
    		...
    		<td><button type='button' onclick="printOpen('${row.idx}');" class="btn btn-danger" style="width:60px;">라벨</button></td>
    	</tr>
    	</c:if>
    </c:forEach>
    </table>
